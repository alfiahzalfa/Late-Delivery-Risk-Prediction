...
from backend.app.schemas.prediction import (
    PredictS1Request, PredictS2Request, PredictResponse,
)
from backend.app.services.predictor import (
    MODEL_S1, MODEL_S2,
    encode_s1, encode_s2,
    run_prediction, save_to_mongo,
)
...
async def predict_s1(req: PredictS1Request):
    """Prediksi risiko keterlambatan — Skenario 1 (Pre-Shipment)."""
    try:
        X = encode_s1(req)
...
async def predict_s2(req: PredictS2Request):
    """Prediksi risiko keterlambatan — Skenario 2 (Full Order Profile)."""
    try:
        X = encode_s2(req)
